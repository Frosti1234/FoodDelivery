...
import com.mar.fooddelivery.pojo.Product;
        ...
        try{
            if(jwtFilter.isAdmin()){
                if(this.validateProductMap(requestMap, false)){
                    ...
                    return FoodDeliveryUtility.getResponseEntity(FoodDeliveryMessages.PRODUCT_ADD_SUCCESS, HttpStatus.OK);
                }
            ...
            if(jwtFilter.isAdmin()){
                if(this.validateProductMap(requestMap, true)){
                    ...
                    if(productDaoById.isPresent()){
                        ...
                        return FoodDeliveryUtility.getResponseEntity(FoodDeliveryMessages.PRODUCT_UPDATE_SUCCESS + requestMap.get("id"), HttpStatus.OK);
                    } else return FoodDeliveryUtility.getResponseEntity(FoodDeliveryMessages.PRODUCT_NOT_EXIST + requestMap.get("id"), HttpStatus.NOT_FOUND);
                } else return FoodDeliveryUtility.getResponseEntity(FoodDeliveryMessages.INVALID_DATA, HttpStatus.BAD_REQUEST);
        ...
        try {
            if(jwtFilter.isAdmin()){
                ...
                if(product.isPresent()){
                    ...
                    return FoodDeliveryUtility.getResponseEntity(FoodDeliveryMessages.PRODUCT_DELETE_SUCCESS, HttpStatus.OK);
                } else return FoodDeliveryUtility.getResponseEntity(FoodDeliveryMessages.PRODUCT_NOT_EXIST + id, HttpStatus.NOT_FOUND);
            } else return FoodDeliveryUtility.getResponseEntity(FoodDeliveryMessages.UNAUTHORIZED_ACCESS, HttpStatus.UNAUTHORIZED);
        } catch (Exception exception){
            exception.printStackTrace();
        }
